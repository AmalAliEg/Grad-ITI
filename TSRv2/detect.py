...
my_model = keras.models.load_model('/home/aml/Desktop/TSRv2/TSRS_model.h5')
...
while True:
    ...
    # Display the class and probability only if the probability exceeds the threshold
    class_name = getCalssName(classIndex)
    cv2.putText(imgOrignal, f"CLASS: {class_name}", (20, 35), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
    cv2.putText(imgOrignal, f"PROBABILITY: {probabilityValue:.3%}", (20, 75), font, 0.75, (0, 0, 255), 2, cv2.LINE_AA)
