...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
//char Message_1[]="I Am Abdallah Essam\r\n";
//char Message_2[]="I Am ITI Student\r\n";
/* USER CODE END 0 */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	//Recieve_Status Recieve_flag =Recieve_NOK;
  ...
  /* USER CODE BEGIN WHILE */
	...
	while (1)
	{
		...
		//		{
		//			HAL_TIM_Base_Start_IT(&htim3);
		//			Recieve_flag =Recieve_OK;
		//		}
		//		else
		//		{
		//			Recieve_flag =Recieve_NOK;
		//		}
